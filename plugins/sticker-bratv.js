...
if (!text) return conn.sendMessage(m.chat, { text: `🐱 𓆩 ***COTTI BOTS x Marie*** 𓆪 🐱\n\n💖 *Marie dice: responde a un mensaje o ingresa un texto para crear el sticker*` }, { quoted: m })
...
await m.react('❌')
conn.sendMessage(m.chat, { text: `🐱 𓆩 ***COTTI BOTS x Marie*** 𓆪 🐱\n\n😿 *Marie dice: se ha producido un problema*\n┆ usa *report* para informarlo.\n\n*Detalle:* ${e.message}` }, { quoted: m })
}}

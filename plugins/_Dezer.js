...
const D = {
    ...
    border2: '╰── 𓆩🌸𓆪 ──╯',
    title: '𝐂𝐎𝐓𝐓𝐈 𝐌𝐔𝐒𝐈𝐂',
    footer: '> "Florece con cada nota" 🦋',
    process: '🪷 FLOTANDO ENTRE NOTAS',
    found: '🌸 FLOR ENCONTRADA',
    error: '🥀 NO FLORECIÓ'
}
...
const handler = async (m, { conn, command }) => {
    try {
        ...
        if (!mime || !/audio|video/.test(mime)) return m.reply(`${D.border}
